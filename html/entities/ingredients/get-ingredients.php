...
function getIngredients(?array $columns = null): array
{
    if (!is_array($columns)) {
        $columns = [];
    }
    ...
    $getUserQuery = $databaseConnection->prepare("SELECT * FROM Ingredient WHERE $whereClause;");
